...
public class FruitListPanel extends JPanel{
	...
	public FruitListPanel(FruitListModel model)
	{
		...
		//J Label
		this.removeLabel = new JLabel("Removed: " + fruitListModel.getAmountRemoved());
		this.removeLabel.setLocation(175, 80);
		this.removeLabel.setSize(100, 25);
		add(removeLabel);
	...
	public void update()
	{
		...
		this.removeLabel.setText("Removed: "+ fruitListModel.getAmountRemoved()); 
